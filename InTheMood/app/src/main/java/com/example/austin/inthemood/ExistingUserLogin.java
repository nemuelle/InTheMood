 ...
 */
public class ExistingUserLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(ExistingUserLogin.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        /**
         * Here is where the results of a log in attempt are handled.
         *
         * @param success
         */
        @Override
